...
<table class="easyui-datagrid" id="itemList" title="商品列表"
       data-options="singleSelect:false,collapsible:true,pagination:true,url:'/good/items',method:'get',pageSize:30,toolbar:toolbar">
    <thead>
    <tr>
...
<div id="itemEditWindow" class="easyui-window" title="编辑商品"
     data-options="modal:true,closed:true,iconCls:'icon-save',href:'/good/item-edit'"
...
<script>
    ...
    var toolbar = [{
        ...
        iconCls: 'icon-add',
        handler: function () {
            $(".tree-title:contains('商品新增')").parent().click();
        }
    }, {
        text: '编辑',
        iconCls: 'icon-edit',
        ...
        iconCls: 'icon-remove',
        handler: function () {
            $.messager.confirm('确认', '导出excel？', function (r) {
                if (r) {
                    window.location.href = "/good/downGoodsExcel"
                }
            });
        }
    }];
