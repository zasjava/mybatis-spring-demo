    <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
        ...
        <meta name="Keywords" content="进口食品,网上超市,网上购物
        ,进口奶粉,宜立方商城,sfbest,母婴用品,营养保健品,生鲜食品,粮油,酒水,休闲食品">
        ...
        <link rel="stylesheet" type="text/css" href="../../css/index123.css?v=2016071312">
        ...
        <div id="index_slide" class="slide_wrap">
            ${lists==null}
        <ol>
        <c:forEach items="${lists}" var="node" varStatus="status">
            <li>
        ...
        <div class="rImg2">
        <a name="sfbest_hp_hp_news_right-ad" class="trackref" href="/html/activity/1472464260.html" target="_blank"><img
        salt="9.2-9.5" src="/images/goods/751d2091c008c2a49c1934545730f041.jpg"></a>
        </div>
        ...
        <!--楼层 start-->
        <div class="indexW mt2 full_ad" style="width:1190px;padding-left:10px;"><a name="sfbest_hp_hp_banner_1"
        class="trackref" href="/html/activity/1472461333.html" target="_blank"><img alt="8.30-9.5" class="lazy"
        ...
        <h2>
        <em></em>
        <a name="sfbest_hp_hp_floor1_floor-category1" class="trackref" href="/fresh/52-0-0-0-0-2-0-0-0-0-0.html"
        target="_blank">水果</a>&nbsp;&nbsp;<a name="sfbest_hp_hp_floor1_floor-category2" class="trackref"
        ...
        target="_blank">
        <img alt="8.30-9.5" class="lazy" src="/images/goods/26336113289bf7273823080488a9d200.jpg" style="display:
        inline;"></a></div>
        </div>
        <div class="sfRight">
        <div class="subCont">
        ...
        <li><a name="sfbest_hp_hp_floor1_Keywords9" class="trackref" href="/fresh/55-9695-0-0-0-2-0-0-0-0-0.html"
        target="_blank">加利利</a></li>
        </ul>
        <div class="clr"></div>
        <div class="rimg">
        ...
        src="http://001.sfimg.cn/web/1dd1130a/1dd1130a9c0103f6ec8a13fa13f27641.jpg" style="display: inline;"></a>
